...
public class ChangeFragment extends Fragment {
    ...
    private static final String SAVE_WISSELKOERS = "Wisselkoers";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Als de Wisselkoers is opgeslaan in savedInstanceStat ->
        if (savedInstanceState != null) {
            currentRateBitcoinInEuro = Float.parseFloat(savedInstanceState.getString(SAVE_WISSELKOERS));
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        // Indien er op Back wordt geduwt bij het volgende fragment of app crasht in dit fragment
        outState.putFloat(SAVE_WISSELKOERS, currentRateBitcoinInEuro);
    }
